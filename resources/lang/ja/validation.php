...
return [
    ...
    */
    ...
    'alpha_num'            => '入力必須です。:attributeには8文字以上20文字以内の英数字のみ。指定してください。',
    ...
    'between'              => [
        ...
        'string'  => '入力必須です。:attributeには2文字以上12文字以下を指定してください。',
        'array'   => ':attributeには:min〜:max個の要素を持つ配列を指定してください。',
    ],
    'boolean'              => ':attributeには真偽値を指定してください。',
    'confirmed'            => '入力必須です。:attributeが確認用の値と一致しません。',
    ...
    'email'                => '入力必須です。:attributeには正しい形式のメールアドレスを指定してください。',
